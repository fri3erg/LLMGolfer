...
class AssistantGolfer:
    ...
    def get_simple_text_response(self, prompt: str) -> str:
        ...
        Used for celebrations or regrets (non-tool calls).
        ...
        try:
            ...
            # FIX: Handle case where content is None by defaulting to empty string
            ...
            return "I am speechless." # Fallback text so the game doesn't crash
                ...
                "function": {
                    ...
                    "parameters": {
                        ...
                        "properties": {
                            ...
                            "aim_degrees": {"type": "integer", "description": "Angle between 45 and 135."},

                            "strike_force": {"type": "integer", "description": "Force 1-100."},

                            "commentary": {"type": "string", "description": "Short, witty comment (max 10 words)."}
